<div class="py-3 py-md-4 checkout">
    <div class="container">
        ...
        <hr>
        @if ($total_price == 0)
            <span class="card card-body shadow text-center">There is not Items added to cart </span>
        @else
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">$ {{ $this->total_price }}</span>
                        </h4>
                        <hr>
                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="phone" wire:model.defer='phone' class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="pincode" wire:model.defer='pincode' class="form-control"
